...
OBJS=boot.o common-s.o main.o common.o gdt-idt-s.o gdt-idt.o isr.o monitor.o timer.o kheap.o paging-s.o paging.o ordered-array.o fs.o initrd.o process.o task.o syscall.o syscall-s.o ds.o keyboard.o shell.o
